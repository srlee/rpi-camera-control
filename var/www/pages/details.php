...
<div class="container details">
    ...
    <table>
        <tr id="check-system">
            <td class="check"><i class="glyphicon glyphicon-cog"></i> System</td>
            <td class="icon"></td>
            <td class="infos">
        ...
        <tr id="check-uptime">
            <td class="check"><i class="glyphicon glyphicon-time"></i> Uptime</td>
            <td class="icon"></td>
        ...
        <tr id="check-cpu">
            <td class="check"><i class="glyphicon glyphicon-tasks"></i> CPU</td>
        ...
        <tr class="storage" id="check-storage">
            ...
            <td class="infos">
              <i class="glyphicon glyphicon-folder-open"></i> ', $hdd[$i]['name'], '
              <div class="progress">
        ...
        <tr id="check-network">
            <td class="check"><i class="glyphicon glyphicon-globe"></i> Network</td>
            ...
            <td class="infos">
                ...
                <br />eth0 received: <strong><?php echo $net_eth['down']; ?>Mb</strong> &middot; sent: <strong><?php echo $net_eth['up']; ?>Mb</strong> &middot; total: <?php echo $net_eth['total']; ?>Mb
                <br />wlan0 received: <strong><?php echo $net_wlan['down']; ?>Mb</strong> &middot; sent: <strong><?php echo $net_wlan['up']; ?>Mb</strong> &middot; total: <?php echo $net_wlan['total']; ?>Mb
        ...
        <tr id="check-users">
            <td class="check"><i class="glyphicon glyphicon-user"></i> Users</td>
        ...
        if ($temp['degrees'] != "N/A") {
            ?>
            <tr id="check-temp">
                <td class="check"><i class="glyphicon glyphicon--fire"></i> DS18B20</td>
